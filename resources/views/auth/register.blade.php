            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mt-3">
                            <div class="col-md-4">
                                <label for="account-type" class="col-md-4 col-form-label text-md-right">{{ __('¿Que eres?') }}</label>

                            </div>
                            <div class="col-md-6">
                                <select name="role_as" id="account-type" class="form-select">
                        ...
                        <div class="row">
                            <div class="col text-center">
                                {{ __('¿Ya tienes una cuenta?') }} <a href="{{ route('login') }}">Inicia sesión</a>
                            </div>
                        </div>
                    </form>
                </div>
